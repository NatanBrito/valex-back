...
cardRouter.post("/create-card", schemaValidateMiddleware(bodySchema), CreateCard);
cardRouter.post("/activecard", schemaValidateMiddleware(ActiveCardSchema), activeCard);
cardRouter.post("/blockCard", schemaValidateMiddleware(BlockUnlockCardSchema), blockCard);
cardRouter.post("/UnlockCard", schemaValidateMiddleware(BlockUnlockCardSchema), UnlockCard);
cardRouter.post("/recharge", schemaValidateMiddleware(rechargeCardSchema), rechargeCard);
cardRouter.post("/purchase", schemaValidateMiddleware(purchaseCardSchema), Purchase);
